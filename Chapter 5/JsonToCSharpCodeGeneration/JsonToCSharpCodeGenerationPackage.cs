...
namespace JsonToCSharpCodeGeneration
{
    ...
    {
        /// <summary>
        /// JsonToCSharpCodeGenerationPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "7f598ea7-ac90-4b85-b961-c2adaaa3b542";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await ApplyCodeGenerationCommand.InitializeAsync(this);
        }
